pipelineJob('infrastructure/tf_management_infrastructure') {
    parameters {
      ...
      stringParam('CONSUL_ACL_TOKEN', '', 'Master ACL token for Consul')
    ...
    definition {
      cps {
          script(readFileFromWorkspace('terraform/modules/services/jenkins/dsl/scripts/management_infrastructure.groovy'))
      }
    }
}

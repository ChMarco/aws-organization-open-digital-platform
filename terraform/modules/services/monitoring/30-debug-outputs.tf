data "null_data_source" "debug_outputs" {
  ...
  inputs = {
    ...
    monitoring_public_key = "${var.vpc_id}"
    monitoring_subnets = "${var.monitoring_subnets}"
    monitoring_elb_subnets = "${var.monitoring_elb_subnets}"
    monitoring_ssh_bastion_access = "${var.monitoring_ssh_bastion_access}"
